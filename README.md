# This repo will continue to be maintained as it does not have a large overhead, but I have stood up a (currently, slightly) [larger NUR that includes the proton-cachyos packages](https://github.com/powerofthe69/nix-gaming-edge) as well as a module for Nix installation of mesa-git (cached!), and packages for vintage-story, pokemmo, and whatever else I decide to update. I recommend using that!
